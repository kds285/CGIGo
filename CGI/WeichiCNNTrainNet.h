...
public:
	WeichiCNNTrainNet(CNNNetParam param, string solover)
		...
		, m_gpu_size(-1), m_label_size(-1), m_sl_label_size(-1), m_bv_label_size(-1), m_vn_label_size(-1)
		, m_sl_distribution_label_size(-1), m_moveNumber(nullptr), m_label(nullptr), m_symmetric(nullptr)
		, m_bRandomInitWeight(false),m_vn_label(nullptr), m_sl_label(nullptr), m_bv_label(nullptr)
	...
	inline bool hasSLDistribution() const { return (m_sl_distribution_label_size != -1); }
